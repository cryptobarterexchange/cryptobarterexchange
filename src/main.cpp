...
uint256 hashGenesisBlock("0x5a731f0892db33a92c1b7328acb0305556c46f4c3b47916f27184be24b0f6ffa");
...
const string strMessageMagic = "Crypto Barter Exchange Signed Message:\n";
...
static const int64 nTargetTimespan = 2 * 60 * 60; // Crypto Barter Exchange: Adjust difficulty every 24hrs
static const int64 nTargetSpacing = 158; // Crypto Barter Exchange: 2.6 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal cryptobarterexchange miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Crypto Barter Exchange", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1390782849; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 269296;

        if (fTestNet)
        {
            block.nTime    = 1389284267;
            block.nNonce   = 0;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x0bd9a5c21aa4ae5ca1e1cd4acde6e3066093267a5ce38569530b548e0c374716"));
